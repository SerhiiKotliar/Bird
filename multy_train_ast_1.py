...
class CleanDataset(MelDataset):
    ...
    def __getitem__(self, idx):
        ...
        target = torch.full((num_classes,), smooth / (num_classes - 1))
        for lab in label:
...
if __name__ == "__main__":
    ...
    # Убираем verbose=True для совместимости со старыми версиями PyTorch
    ...
    for epoch in range(1, CFG["epochs"] + 1):
        ...
        print(f"Epoch {epoch:2d} | TrLoss: {train_loss:.4f} | VaLoss: {val_loss:.4f} | Acc: {val_acc:.4f} | LR: {current_lr:.2e}")
